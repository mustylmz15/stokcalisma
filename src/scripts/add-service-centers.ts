...
async function addServiceCenter(serviceCenter: Omit<ServiceCenter, 'id' | 'createdAt' | 'createdBy'>): Promise<boolean> {
    try {
        const serviceCentersRef = collection(db, 'serviceCenters');
        const newCenter: Omit<ServiceCenter, 'id'> = {
            ...serviceCenter,
            createdBy: 'system',
...
async function main(): Promise<void> {
    ...
    const serviceCentersToAdd: Omit<ServiceCenter, 'id' | 'createdAt' | 'createdBy'>[] = [
        {
