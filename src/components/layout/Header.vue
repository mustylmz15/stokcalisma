        ...
        <div class="shadow-sm">
            <div class="relative bg-white flex w-full items-center px-5 py-2.5 dark:bg-[#0e1726]">
                ...
                >
                    ...
                    <!-- Proje Seçim Butonu - Tüm oturum açmış kullanıcılar için görünür -->
                    <ProjectSelector v-if="authStore.isLoggedIn" />
                                    ...
                                    <template v-for="item in store.languageList" :key="item.code">
                                        <li>
                                            <button
                                                ...
                                                :class="{ 'bg-primary/10 text-primary': i18n.global.locale.value === item.code }"
                        ...
                        <Popper :placement="store.rtlClass === 'rtl' ? 'bottom-end' : 'bottom-start'" offsetDistance="8" class="!block align-middle">
                            <button type="button" class="relative group block">
                                <img
                                    ...
                                    :src="authStore.userInfo?.avatar || '/assets/images/user-profile.jpeg'"
                                    alt=""
                                />
                            </button>
                            <template #content="{ close }">
                                <ul class="text-dark dark:text-white-dark !py-0 w-[230px] font-semibold dark:text-white-light/90">
                                    <li>
                                        <div class="flex items-center px-4 py-4">
                                            <div class="flex-none">
                                                <img class="rounded-md w-10 h-10 object-cover" :src="authStore.userInfo?.avatar || '/assets/images/user-profile.jpeg'" alt="" />
                                            </div>
                                    ...
                                    <li class="border-t border-white-light dark:border-white-light/10">
                                        <a href="javascript:;" class="text-danger !py-3" @click="handleSignOut(); close();">
...
<script lang="ts" setup>
    ...
    // multi language - useI18n yerine doğrudan i18n modülünü kullanıyoruz
    const changeLanguage = (item: any) => {
        i18n.global.locale.value = item.code;
        appSetting.toggleLanguage(item);
    };

    const currentFlag = computed(() => {
        return `/assets/images/flags/${i18n.global.locale.value.toUpperCase()}.svg`;
    });
